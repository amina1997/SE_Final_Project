...
function Landing() {
    ...
    //create the amnimation of the objects
  ...
  return (
    <div id='wrap'>
        ...
        {/*discriptive text*/}
        <div id='first-text' className="text">Learn, Find Bugs and <h1>teach</h1></div>
