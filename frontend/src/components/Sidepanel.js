...
class Sidepanel extends React.Component {
    render() {
        return (
            ...
            <div id="profile">
                <div className="wrap">
                <img id="profile-img" src="https://i.ibb.co/h8c2mVm/undraw-female-avatar-w3jk.png" alt="undraw-female-avatar-w3jk" border="0" />
                <p>Fun Fact</p>
            ...
            <div id="contacts">
                ...
                <li className="contact">
                    ...
                    <img src="https://i.ibb.co/JmpPfkg/undraw-male-avatar-323b.png" alt="undraw-male-avatar-323b" border="0" />
                    <div className="meta">
                        <p className="name">fiona</p>
                ...
                <li className="contact active">
                    ...
                    <img src="https://i.ibb.co/JmpPfkg/undraw-male-avatar-323b.png" alt="undraw-male-avatar-323b" border="0" />
                    <div className="meta">
                        <p className="name">Kevin Mitnick</p>
